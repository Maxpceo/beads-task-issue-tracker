    ...
    <Dialog :open="needsMigration" @update:open="(open) => !open && dismissMigration()">
      <DialogContent class="sm:max-w-lg">
        ...
        <div class="flex justify-end gap-2 mt-4">
          ...
          <Button :disabled="isMigrating" class="bg-dolt hover:bg-dolt-hover text-black" @click="handleMigrateToDolt">
    ...
    <Dialog :open="needsRefsMigration" @update:open="(v: boolean) => { if (!v) dismissRefsMigration() }">
      <DialogContent class="sm:max-w-[480px]">
        ...
        <div class="flex justify-end gap-2 mt-4">
          ...
          <Button :disabled="isRefsMigrating" class="bg-dolt hover:bg-dolt-hover text-black" @click="handleMigrateRefs">
