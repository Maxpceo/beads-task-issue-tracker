...
2. First complete after entering plan mode opens ready-UI. After ask/refine/dirty plan-review, wait for a whole-message confirm before calling `plan_mode_complete({ plan })` again.
