...
Full PR + docs + merge cycle for a feature branch. Do not run `land` before this skill; merge-to-main includes commit/push.
...
3. Resolve feature-related open beads only. Treat unrelated beads from parallel sessions as background; do not block on them.
